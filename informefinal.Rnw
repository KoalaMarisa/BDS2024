...
library(ggplot2)
library(knitr)
m8datos_limpios <-  read.csv(here("data", "m8datoslimpios.csv"))
@
...
\begin{figure}[h!]
<<echo=FALSE, fig.width=8, fig.height=6, fig.cap="Relación entre felicidad, salud y genero">>=
